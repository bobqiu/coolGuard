...
]', '', '公共服务配置', NULL, '2024-04-07 18:32:10', NULL, '2024-11-16 09:41:02', 0);
...
INSERT INTO coolGuard.de_field (display_name, name, group_name, standard, `type`, description, default_value, `dynamic`,
                                script, creator, create_time, updater, update_time, deleted)
VALUES ('应用名', 'N_S_appName', 'CUST', 1, 'S', '应用名', NULL, 0, NULL, '', '2024-04-06 19:45:03', '',
        '2024-11-16 10:34:32', 0),
       ('交易时间', 'N_D_transTime', 'CUST', 1, 'D', '交易时间', NULL, 0, NULL, '', '2024-04-06 19:45:03', '',
        '2024-11-16 10:34:32', 0),
       ('交易金额', 'N_F_transAmount', 'CUST', 1, 'F', '交易金额', NULL, 0, NULL, '', '2024-04-06 19:45:03', '',
        '2024-11-16 10:34:32', 0),
       ('交易流水号', 'N_S_transSerialNo', 'CUST', 1, 'S', '交易流水号', NULL, 0, NULL, '', '2024-04-06 19:45:03', '',
        '2024-11-16 10:34:32', 0),
       ('收款方账户', 'N_S_payeeAccount', 'CUST', 1, 'S', '收款方账户', NULL, 0, NULL, '', '2024-04-06 19:45:03', '',
        '2024-11-16 10:34:32', 0),
       ('付款方账户', 'N_S_payerAccount', 'CUST', 1, 'S', '付款方账户', NULL, 0, NULL, '', '2024-04-06 19:45:03', '',
        '2024-11-16 10:34:32', 0),
       ('收款方名称', 'N_S_payeeName', 'CUST', 1, 'S', '收款方名称', NULL, 0, NULL, '', '2024-04-06 19:45:03', '',
        '2024-11-16 10:34:32', 0),
       ('付款方名称', 'N_S_payerName', 'CUST', 1, 'S', '付款方名称', NULL, 0, NULL, '', '2024-04-06 19:45:03', '',
        '2024-11-16 10:34:32', 0),
       ('收款方类型', 'N_S_payeeType', 'CUST', 1, 'S', '收款方类型', NULL, 0, NULL, '', '2024-04-06 19:45:03', '',
        '2024-11-16 10:34:32', 0),
       ('付款方类型', 'N_S_payerType', 'CUST', 1, 'S', '付款方类型', NULL, 0, NULL, '', '2024-04-06 19:45:03', '',
        '2024-11-16 10:34:32', 0);
INSERT INTO coolGuard.de_field (display_name, name, group_name, standard, `type`, description, default_value, `dynamic`,
                                script, creator, create_time, updater, update_time, deleted)
VALUES ('收款方风险评级', 'N_S_payeeRiskRating', 'CUST', 1, 'S', '收款方风险评级', NULL, 0, NULL, '',
        '2024-04-06 19:45:03', '', '2024-11-16 10:34:32', 0),
       ('付款方风险评级', 'N_S_payerRiskRating', 'CUST', 1, 'S', '付款方风险评级', NULL, 0, NULL, '',
        '2024-04-06 19:45:03', '', '2024-11-16 10:34:32', 0),
       ('收款方银行名', 'N_S_payeeBankName', 'CUST', 1, 'S', '收款方银行名', NULL, 0, NULL, '', '2024-04-06 19:45:03',
        '', '2024-11-16 10:34:32', 0),
       ('付款方银行名', 'N_S_payerBankName', 'CUST', 1, 'S', '付款方银行名', NULL, 0, NULL, '', '2024-04-06 19:45:03',
        '', '2024-11-16 10:34:32', 0),
       ('收款方地址', 'N_S_payeeAddress', 'CUST', 1, 'S', '收款方地址', NULL, 0, NULL, '', '2024-04-06 19:45:03', '',
        '2024-11-16 10:34:32', 0),
       ('付款方地址', 'N_S_payerAddress', 'CUST', 1, 'S', '付款方地址', NULL, 0, NULL, '', '2024-04-06 19:45:03', '',
        '2024-11-16 10:34:32', 0),
       ('收款方手机号', 'N_S_payeePhoneNumber', 'CUST', 1, 'S', '收款方手机号', NULL, 0, NULL, '',
        '2024-04-06 19:45:03', '', '2024-11-16 10:34:32', 0),
       ('付款方手机号', 'N_S_payerPhoneNumber', 'CUST', 1, 'S', '付款方手机号', NULL, 0, NULL, '',
        '2024-04-06 19:45:03', '', '2024-11-16 10:34:32', 0),
       ('收款方证件号码', 'N_S_payeeIDNumber', 'CUST', 1, 'S', '收款方证件号码', NULL, 0, NULL, '',
        '2024-04-06 19:45:03', '', '2024-11-16 10:34:32', 0),
       ('付款方证件号码', 'N_S_payerIDNumber', 'CUST', 1, 'S', '付款方证件号码', NULL, 0, NULL, '',
        '2024-04-06 19:45:03', '', '2024-11-16 10:34:32', 0);
INSERT INTO coolGuard.de_field (display_name, name, group_name, standard, `type`, description, default_value, `dynamic`,
                                script, creator, create_time, updater, update_time, deleted)
VALUES ('收款方证件所属国家/地区', 'N_S_payeeIDCountryRegion', 'CUST', 1, 'S', '收款方所属国家/地区', NULL, 0, NULL, '',
        '2024-04-06 19:45:03', '', '2024-11-16 10:34:32', 0),
       ('付款方证件所属国家/地区', 'N_S_payerIDCountryRegion', 'CUST', 1, 'S', '付款方所属国家/地区', NULL, 0, NULL, '',
        '2024-04-06 19:45:03', '', '2024-11-16 10:34:32', 0),
       ('策略集code', 'N_S_policySetCode', 'CUST', 1, 'S', '策略集code', NULL, 0, NULL, '', '2024-04-07 08:53:19', '',
        '2024-11-16 10:34:32', 0),
       ('策略code', 'N_S_policyCode', 'CUST', 1, 'S', '策略code', NULL, 0, NULL, '', '2024-04-07 08:53:19', '',
        '2024-11-16 10:34:32', 0),
       ('证件号所属省名称', 'N_S_idCardProvince', 'CUST', 1, 'S', '证件号所属省名称', NULL, 0, NULL, '',
        '2024-04-30 16:08:38', '', '2024-11-16 10:34:32', 0),
       ('证件号所属市名称', 'N_S_idCardCity', 'CUST', 1, 'S', '证件号所属市名称', NULL, 0, NULL, '',
        '2024-04-30 16:08:38', '', '2024-11-16 10:34:31', 0),
       ('证件号所属区/县名称', 'N_S_idCardDistrict', 'CUST', 1, 'S', '证件号所属区/县名称', NULL, 0, NULL, '',
        '2024-04-30 16:08:38', '', '2024-11-16 10:34:32', 0),
       ('手机号号所属省名称', 'N_S_phoneNumberProvince', 'CUST', 1, 'S', '手机号所属省名称', NULL, 0, NULL, '',
        '2024-04-30 16:08:38', '', '2024-11-16 10:34:32', 0),
       ('手机号号所属市名称', 'N_S_phoneNumberCity', 'CUST', 1, 'S', '手机号所属市名称', NULL, 0, NULL, '',
        '2024-04-30 16:08:38', '', '2024-11-16 10:34:32', 0),
       ('手机号号ISP', 'N_S_phoneNumberIsp', 'CUST', 1, 'S', '手机号所属运营商', NULL, 0, NULL, '',
        '2024-04-30 16:08:38', '', '2024-11-16 10:34:32', 0);
INSERT INTO coolGuard.de_field (display_name, name, group_name, standard, `type`, description, default_value, `dynamic`,
                                script, creator, create_time, updater, update_time, deleted)
VALUES ('IP所属国家名称', 'N_S_ipCountry', 'CUST', 1, 'S', 'IP归属国家名称', NULL, 0, NULL, '', '2024-04-30 16:08:38',
        '', '2024-11-16 10:34:32', 0),
       ('IP所属省名称', 'N_S_ipProvince', 'CUST', 1, 'S', 'IP归属省名称', NULL, 0, NULL, '', '2024-04-30 16:08:38', '',
        '2024-11-16 10:34:32', 0),
       ('IP所属市名称', 'N_S_ipCity', 'CUST', 1, 'S', 'IP归属市名称', NULL, 0, NULL, '', '2024-04-30 16:08:38', '',
        '2024-11-16 10:34:32', 0),
       ('IP所属isp', 'N_S_ipIsp', 'CUST', 1, 'S', 'IP归属运营商', NULL, 0, NULL, '', '2024-04-30 16:08:38', '',
        '2024-11-16 10:34:32', 0),
       ('经纬度', 'N_S_lonAndLat', 'CUST', 1, 'S', '经纬度字符串，格式必须是 "经度,纬度"', NULL, 0, NULL, '',
        '2024-04-30 16:08:38', '', '2024-11-16 10:34:32', 0),
       ('经纬度所在省名称', 'N_S_geoProvince', 'CUST', 1, 'S', '经纬度所在省名称', NULL, 0, NULL, '',
        '2024-04-30 16:08:38', '', '2024-11-16 10:34:32', 0),
       ('经纬度所在市名称', 'N_S_geoCity', 'CUST', 1, 'S', '经纬度所在市名称', NULL, 0, NULL, '', '2024-04-30 16:08:38',
        '', '2024-11-16 10:34:32', 0),
       ('经纬度所在区/县名称', 'N_S_geoDistrict', 'CUST', 1, 'S', '经纬度所在区/县名称', NULL, 0, NULL, '',
        '2024-04-30 16:08:38', '', '2024-11-16 10:34:32', 0),
...
INSERT INTO coolGuard.de_indicator (code, name, status, `type`, calc_field, return_type, return_flag, win_size,
                                    ...
                                    version, scenes, scene_type, description, creator, create_time, updater,
                                    update_time, deleted)
VALUES ('b75c84a6b5ec45ed8026ca7c873e789c', '24小时交易金额之和', 1, 'sum', 'N_F_transAmount', 'F', 'earliest', 'H',
        'last', 24, 86400, 'N_S_payerAccount', '', '', 0, 'phone', 'appName', '金额求和', '', '2024-04-15 10:48:31',
        NULL, '2024-11-16 09:51:59', 0),
       ('72df2843a1094b2c8b8f6c4aebeb63dd', '24小时交易金额最大', 1, 'max', 'N_F_transAmount', 'F', 'earliest', 'H',
        'last', 24, 86400, 'N_S_payerAccount', '', '', 0, 'phone:login', 'policySet', '', '', '2024-07-20 11:10:31', '',
        '2024-11-16 09:51:59', 0),
       ('d43b398568a24d9dbc82aae162f41ed6', '选必于', 1, 'sum', 'N_F_transAmount', 'F', 'earliest', 'D', 'last', 3,
        7776000, 'N_S_payerAccount', '', '', 0, 'phone', 'appName', '管军重中车更儿专比十接一时条。', NULL,
        '2024-08-03 20:01:18', NULL, '2024-11-16 09:51:59', 0),
       ('cd420db94e1948c59ea95c535b682975', '24小时交易金额大于10万求和', 1, 'sum', 'N_F_transAmount', 'F', 'earliest',
        'D', 'last', 3, 7776000, 'N_S_payerAccount', '', '', 0, 'phone', 'appName', '金额大于10万求和', NULL,
        '2024-08-21 17:30:23', NULL, '2024-11-16 09:51:59', 0),
       ('fc0547d4e57e431082314c1c1b28b121', '规支才公照还', 1, 'ass', 'N_S_payeeAccount', 'F', 'earliest', 'H', 'last',
        24, 3600, 'N_S_payerAccount', '', '', 0, 'phone', 'appName', '计行民平来铁及长么气社组较在先比例。', NULL,
        '2024-08-22 10:33:18', NULL, '2024-11-16 09:51:59', 0),
       ('c689576cf38d45888729c537697897af', '且者矿', 1, 'max', 'N_F_transAmount', 'F', 'earliest', 'H', 'last', 24,
        3600, 'N_S_payerAccount', '', '', 0, 'phone', 'appName', '世非克九界重被程局用开必米深专知体格。', NULL,
        '2024-08-22 10:39:29', NULL, '2024-11-16 09:51:59', 0),
       ('b02b2000723e422fbcafbf2cd671cd0b', '北在文地', 1, 'min', 'N_F_transAmount', 'F', 'earliest', 'H', 'last', 24,
        3600, 'N_S_payerAccount', '', '', 0, 'phone', 'appName', '般我五清其断界圆阶现性史派业反山他入。', NULL,
        '2024-08-22 10:39:33', NULL, '2024-11-16 09:51:59', 0),
       ('9d07af28e7624571b89c9eacd65bac2d', '看活历地许', 1, 'avg', 'N_F_transAmount', 'F', 'earliest', 'H', 'last', 24,
        3600, 'N_S_payerAccount', '', '', 0, 'phone', 'appName', '意素国府使造门安织应方行电。', NULL,
        '2024-08-22 10:39:39', NULL, '2024-11-16 09:51:59', 0),
       ('a7f924197fb0497ea8718c386d1c7db7', '情性特问写养八', 1, 'sum', 'N_F_transAmount', 'F', 'earliest', 'H', 'last',
        24, 3600, 'N_S_payerAccount', '', '', 0, 'phone', 'appName', '能率行主务直流明圆眼历火传周当日值种。', NULL,
        '2024-08-22 10:39:59', NULL, '2024-11-16 09:51:59', 0),
       ('c161c3943d4449408f75843fff68af4e', '其断子把酸', 1, 'count', '', 'F', 'earliest', 'H', 'last', 24, 3600,
        'N_S_payerAccount', '', '', 0, 'phone', 'appName', '拉县级它入题张长程权圆老所。', NULL, '2024-08-22 10:40:33',
        NULL, '2024-11-16 09:51:59', 0);
INSERT INTO coolGuard.de_indicator (code, name, status, `type`, calc_field, return_type, return_flag, win_size,
                                    win_type, win_count, time_slice, master_field, slave_fields, compute_script,
                                    version, scenes, scene_type, description, creator, create_time, updater,
...
VALUES ('4025845e0cdc498284f0da08c3649242', '大行米', 1, 'his', 'N_F_transAmount', 'F', 'earliest', 'H', 'last', 24,
        3600, 'N_S_payerAccount', '', '', 0, 'phone', 'appName', '切断又划根文相其明场龙义须文之需。', NULL,
        '2024-11-14 18:41:22', NULL, '2024-11-16 09:51:59', 0);
...
INSERT INTO coolGuard.de_rule (policy_code, code, name, disposal_id, score, status, sort, description, creator,
                               create_time, updater, update_time, deleted)
VALUES ('phone_login_order', 'f1df5b70574a46a09b95f3662cffaed9', '付款方账号不为空或者金额大于等于100', 1, 0, 'on', 0,
        'hethethethe', '', '2024-04-07 22:13:58', NULL, '2024-11-16 12:06:54', 0),
       ('phone_login_order', '0b30510bf425492381a78aca098be029', '测试规则02', 1, 0, 'on', 2, '', '',
        '2024-04-07 22:14:32', '', '2024-11-16 12:06:54', 0),
       ('phone_login_worst', '6ae5cb587c784326b45c944e80319d50', '测试规则03', 1, 0, 'on', 99, '', '',
        '2024-04-09 10:56:48', '', '2024-11-16 12:06:54', 0);
