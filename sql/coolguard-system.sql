...
(
    ...
    code        varchar(100)                          not null comment '字典键值',
...
(
    ...
    code        varchar(100)                       not null comment '字典值',
...
(
    ...
    path        varchar(50)                        null comment '路由地址',
...
(
    ...
    result_msg     varchar(512)                       null comment '结果提示',
...
(
    ...
    code        varchar(30)                           not null comment '参数code',
