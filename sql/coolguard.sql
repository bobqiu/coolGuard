...
(
    id                bigint auto_increment comment '自增编号'
        primary key,
    name              varchar(32) charset utf8mb4        not null comment '服务名',
    code              varchar(32) charset utf8mb4        not null comment 'code',
    input_field_list  varchar(5000)                      null,
    output_field_list varchar(5000)                      null,
    test_params       varchar(1000)                      null comment '测试参数',
    description       varchar(64) charset utf8mb4        null comment '描述',
    creator           varchar(32) charset utf8mb4        null comment '创建者',
...
(
    ...
    chain_name       varchar(64)                           not null comment 'chain名',
    el_data          varchar(3000)                         not null comment 'el数据',
...
(
    id          bigint auto_increment comment '主键'
        primary key,
    code        varchar(32)                        not null comment '处置编码',
    name        varchar(32)                        not null comment '处置名',
...
(
    id            bigint auto_increment comment '主键'
        primary key,
    name          varchar(32) charset utf8mb4        not null comment '字段名',
    code          varchar(32) charset utf8mb4        not null comment 'code',
...
(
    id          bigint auto_increment comment '自增编号'
        primary key,
    name        varchar(32) charset utf8mb4        not null comment '分组名',
    code        varchar(32) charset utf8mb4        not null comment 'code',
    standard    bit      default b'0'              not null comment '标准',
    description varchar(64) charset utf8mb4        null comment '描述',
    creator     varchar(32) charset utf8mb4        null comment '创建者',
...
(
    id             bigint auto_increment comment '自增编号'
        primary key,
    code           varchar(32)                           not null comment 'code',
    name           varchar(32) charset utf8mb4           not null comment '指标名',
    publish        bit         default b'0'              not null comment '发布',
    type           varchar(10)                           null comment '类型',
    calc_field     varchar(32) charset utf8mb4           null comment '计算字段',
    return_type    varchar(1)  default 'F'               null comment '返回类型',
    return_flag    varchar(10) default 'earliest'        null comment '返回取值方式',
    win_size       varchar(5) charset utf8mb4            not null comment '窗口大小',
    win_type       varchar(10) charset utf8mb4           not null comment '窗口类型',
    win_count      int         default 0                 not null comment '窗口数量',
    time_slice     bigint      default 0                 not null comment '时间片',
    master_field   varchar(32) charset utf8mb4           null comment '主字段',
    slave_fields   varchar(128) charset utf8mb4          null comment '从字段',
    compute_script varchar(64) charset utf8mb4           null comment '计算脚本',
...
(
    ...
    name            varchar(32)                           not null comment '策略名',
...
(
    ...
    code        varchar(32)                        not null comment '策略集编码',
    name        varchar(32)                        not null comment '策略集名',
    publish     bit      default b'0'              not null comment '发布',
    chain       varchar(5000)                      not null comment '策略chain',
    description varchar(64) charset utf8mb4        null comment '描述',
    creator     varchar(32) charset utf8mb4        null comment '创建者',
    create_time datetime default CURRENT_TIMESTAMP not null comment '创建时间',
    updater     varchar(32) charset utf8mb4        null comment '更新者',
...
(
    id           bigint auto_increment comment '主键'
        primary key,
    app_code     varchar(32)                        not null comment '应用编码',
    code         varchar(32)                        not null comment '策略集code',
    name         varchar(32)                        not null comment '策略集名',
    chain        varchar(5000)                      not null comment '策略集链路',
    description  varchar(64) charset utf8mb4        null comment '描述',
    latest       bit      default b'0'              not null comment '最新',
    version      int      default 1                 not null comment '版本号',
    version_desc varchar(64)                        null comment '版本描述',
...
(
    ...
    rule_id       varchar(6)                            not null comment '规则id',
...
(
    id               bigint auto_increment comment '主键'
        primary key,
    application_name varchar(32)                        not null comment '脚本应用名',
    script_id        varchar(32)                        not null comment '脚本id',
    script_name      varchar(64)                        not null comment '脚本名',
    script_data      varchar(5000)                      not null comment '脚本数据',
    script_type      varchar(16)                        not null comment '脚本类型',
...
(
    id                bigint auto_increment comment '主键'
        primary key,
    event_seq_id      varchar(64)                        not null comment '事件流水号',
...
(
    id          bigint auto_increment comment '主键'
        primary key,
    code        varchar(32)                        not null comment '消息编码',
    name        varchar(32)                        not null comment '消息名',
    content     varchar(1000)                      not null comment '消息内容',
